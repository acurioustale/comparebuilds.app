...
import { sectionPoints, activeHeroSubtree, canSpendPoint } from './spendRules.js'

function node(id, treeType, posY, opts = {}) {
  return {
    id, treeType, posY, posX: opts.posX ?? 0,
...
const GATED   = node(3, 'class', 1, { posX: 1, spentRequired: 5, connections: [1] })
